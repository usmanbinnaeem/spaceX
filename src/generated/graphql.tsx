...
export type LaunchDetailsQuery = (
  ...
  & { launch?: Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'id' | 'mission_name' | 'launch_year' | 'launch_date_local' | 'details' | 'launch_success' | 'upcoming'>
    & { launch_site?: Maybe<(
      { __typename?: 'LaunchSite' }
      & Pick<LaunchSite, 'site_name'>
    )>, links?: Maybe<(
      { __typename?: 'LaunchLinks' }
      & Pick<LaunchLinks, 'video_link' | 'article_link' | 'flickr_images'>
    )>, rocket?: Maybe<(
      { __typename?: 'LaunchRocket' }
      & Pick<LaunchRocket, 'rocket_name' | 'rocket_type'>
    )> }
  )>, missionsResult?: Maybe<(
    { __typename?: 'MissionResult' }
    & { result?: Maybe<(
      { __typename?: 'Result' }
...
export type RocketsDetailsQueryVariables = Exact<{ [key: string]: never; }>;


export type RocketsDetailsQuery = (
  { __typename?: 'Query' }
  & { rockets?: Maybe<Array<Maybe<(
    { __typename?: 'Rocket' }
    & Pick<Rocket, 'id' | 'type' | 'name' | 'company' | 'description'>
    & { engines?: Maybe<(
      { __typename?: 'RocketEngines' }
      & Pick<RocketEngines, 'version' | 'number'>
    )> }
  )>>> }
);
...
export type RocketsListQuery = (
  ...
  & { ships?: Maybe<Array<Maybe<(
    { __typename?: 'Ship' }
    & Pick<Ship, 'name' | 'type' | 'successful_landings' | 'year_built' | 'active' | 'image'>
  )>>> }
);
...
export const RocketsDetailsDocument = gql`
...
/**
 * __useRocketsDetailsQuery__
 *
 * To run a query within a React component, call `useRocketsDetailsQuery` and pass it any options that fit your needs.
 * When your component renders, `useRocketsDetailsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 ...
 * });
 */
export function useRocketsDetailsQuery(baseOptions?: Apollo.QueryHookOptions<RocketsDetailsQuery, RocketsDetailsQueryVariables>) {
        return Apollo.useQuery<RocketsDetailsQuery, RocketsDetailsQueryVariables>(RocketsDetailsDocument, baseOptions);
      }
export function useRocketsDetailsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<RocketsDetailsQuery, RocketsDetailsQueryVariables>) {
          return Apollo.useLazyQuery<RocketsDetailsQuery, RocketsDetailsQueryVariables>(RocketsDetailsDocument, baseOptions);
        }
export type RocketsDetailsQueryHookResult = ReturnType<typeof useRocketsDetailsQuery>;
export type RocketsDetailsLazyQueryHookResult = ReturnType<typeof useRocketsDetailsLazyQuery>;
export type RocketsDetailsQueryResult = Apollo.QueryResult<RocketsDetailsQuery, RocketsDetailsQueryVariables>;
...
export function useRocketsListQuery(baseOptions?: Apollo.QueryHookOptions<RocketsListQuery, RocketsListQueryVariables>) {
        return Apollo.useQuery<RocketsListQuery, RocketsListQueryVariables>(RocketsListDocument, baseOptions);
      }
export function useRocketsListLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<RocketsListQuery, RocketsListQueryVariables>) {
          return Apollo.useLazyQuery<RocketsListQuery, RocketsListQueryVariables>(RocketsListDocument, baseOptions);
        }
